        ...
        <CenterPage>
            <div className={cssModules['home-page']}>
                <div className={cssModules['home-page__title']}>
                    <h1><FontAwesomeIcon icon={faSpaceStationMoonConstruction} /> Site Under Reconstruction <FontAwesomeIcon icon={faSpaceStationMoonConstruction} /></h1>
                </div>
                <Panel className={cssModules['home-page__message']}>
